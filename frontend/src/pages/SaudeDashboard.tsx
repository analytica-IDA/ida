import { Activity, TrendingUp, Users, Wallet, Loader2, MousePointer2, UserPlus, FileCheck, Calendar } from 'lucide-react';
...
export default function SaudeDashboard() {
    ...
    const { data: stats, isLoading } = useQuery<SaudeStats>({
        queryKey: ['saude-stats', selectedClienteId, selectedAreaId, startDate, endDate],
        queryFn: async () => (await api.get('/dashboard/saude', { params: { idCliente: selectedClienteId, idArea: selectedAreaId, dataInicial: startDate, dataFinal: endDate } })).data
    });
        ...
        <div className="space-y-8 animate-in fade-in duration-1000">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                ...
                <div className="flex flex-col md:flex-row gap-4">
                    <div className="flex items-center gap-3 bg-white dark:bg-neutral-900 px-4 py-2 rounded-2xl border border-neutral-200 dark:border-neutral-800 shadow-sm focus-within:ring-2 focus-within:ring-emerald-500/20 transition-all">
