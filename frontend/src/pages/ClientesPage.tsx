        ...
        <div className="p-8 space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 bg-neutral-50 dark:bg-neutral-800/50 p-6 rounded-2xl border border-neutral-100 dark:border-neutral-800">
            ...
            <button 
              ...
              className="md:col-span-2 bg-emerald-600 hover:bg-emerald-700 text-white font-bold py-3 rounded-xl transition-all shadow-lg shadow-emerald-500/25 disabled:opacity-50 flex items-center justify-center gap-2"
            >
          ...
          <div className="space-y-4">
            ...
            <div className="max-h-[300px] overflow-y-auto space-y-2 pr-2 custom-scrollbar">
              {loadingAssoc ? (
                ...
                <div key={assoc.idUsuario} className="flex items-center justify-between p-4 bg-white dark:bg-neutral-800 border border-neutral-100 dark:border-neutral-800 rounded-2xl group hover:border-emerald-500/30 transition-all">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-[10px] font-black uppercase tracking-tighter text-emerald-600">{assoc.area}</p>
                    </div>
                  </div>
                  <button 
...
function ClienteModal({ onClose, cliente }: { onClose: () => void; cliente: Cliente | null }) {
  ...
  const mutation = useMutation({
    mutationFn: (data: typeof formData) => 
      cliente ? api.put(`/cliente/${cliente.id}`, { ...data, id: cliente.id }) : api.post('/cliente', data),
    onSuccess: () => {
